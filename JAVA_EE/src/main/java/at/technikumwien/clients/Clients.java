...
public class Clients {
	...
	public Clients(String firstname, String lastname, Date birthday, boolean activated) {
	...
	public Clients(Long id, String firstname, String lastname, Date birthday, boolean activated) {
		this.id = id;
		this.firstname = firstname;
		this.lastname = lastname;
		this.birthday = birthday;
	...
	public void setActivated(boolean aktiviert) {
